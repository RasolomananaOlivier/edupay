...
public class EquipmentAmount {
	...
	public EquipmentAmount(Integer id, Integer value, Integer levelId, Date createdAt, Date updatedAt) {
		this.id = id;
		this.value = value;
	...
	public static EquipmentAmount fromResultSet(ResultSet resultSet) {
