...
<body>
	...
	<main class="px-5 py-3">
		...
		<div class="bg-slate-100 rounded-lg px-4 py-3 my-4">
		...
		<div class="flex flex-col gap-4 pt-5">
			...
			<div class="flex flex-col gap-5 rounded-md border p-5">
				...
				<div class="flex flex-col">
					...
					<div class="font-semibold text-slate-800"> <%= students.get(i).getName() %> </div>
				</div>
				...
				<div class="flex gap-10">
					...
					<div class="flex flex-col">
						...
						<div class="font-semibold text-slate-800"><%= students.get(i).getGender().getLabel() %> </div>
					</div>
				</div>
				...
				<div class="flex gap-10">
					<div class="flex flex-col">
						...
						<div class="font-semibold text-slate-800"><%= students.get(i).getFaculty().getName() %> </div>
					</div>

					<div class="flex flex-col">
						<div class="text-sm text-slate-700">Niveau</div>
						<div class="font-semibold text-slate-800"><%= students.get(i).getLevel().getName() %> </div>
					</div>

					<div class="flex flex-col">
						<div class="text-sm text-slate-700">Année universitaire</div>
						<div class="font-semibold text-slate-800"><%= students.get(i).getSession().getYear() %> - <%= students.get(i).getSession().getYear() +1 %> </div>
					</div>
				</div>
			</div>
			<%
